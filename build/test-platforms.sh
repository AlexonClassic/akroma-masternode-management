...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "cd /akroma-masternode-management/source && ./dist/akroma-mn-setup -h && yes | TMPDIR=/dev/shm ./akroma-mn-setup && akroma-mn-utils
