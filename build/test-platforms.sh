...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "cd /akroma-masternode-management/source && ls -lah dist && ./akroma-mn-setup.py -h && yes | ./akroma-mn-setup.py && akroma-mn-utils
