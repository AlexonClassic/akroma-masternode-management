...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "cd /akroma-masternode-management/source && cat /proc/mounts && ./dist/akroma-mn-setup -h && TMPDIR=/dev/shm && yes | ./akroma-mn-setup && akroma-mn-utils
