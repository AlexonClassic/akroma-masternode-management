...
docker exec -ti $DOCKER_CONTAINER_ID /bin/bash -xec "yum --enablerepo=extras install epel-release -y && yum --enablerepo=extras install gcc python2-devel python-pip python-setuptools upx -y && echo -ne \"------\nEND DEPENDENCIES INSTALL\n\";"
